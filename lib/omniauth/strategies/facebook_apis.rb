...
require 'omniauth/facebook_apis/signed_request'
require 'openssl'
require 'rack/utils'
require 'uri'
...
module OmniAuth
  module Strategies
    class FacebookApis < OmniAuth::Strategies::OAuth2
      ...
      rescue OmniAuth::FacebookApis::SignedRequest::UnknownSignatureAlgorithmError => e
      ...
      def signed_request_from_cookie
        @signed_request_from_cookie ||= raw_signed_request_from_cookie && OmniAuth::FacebookApis::SignedRequest.parse(raw_signed_request_from_cookie, client.secret)
      end
